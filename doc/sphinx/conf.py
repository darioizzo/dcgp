...
# -*- coding: utf-8 -*-
#
# dCGP documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'dCGP.tex', 'dCGP Documentation',
   'Dario Izzo', 'manual'),
]
...
man_pages = [
    (master_doc, 'dCGP', 'dCGP Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'dCGP', 'dCGP Documentation',
   author, 'dCGP', 'One line description of project.',
   'Miscellaneous'),
]
