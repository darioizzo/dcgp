...
int main(int ac, char *av[])
{
    ...
    desc.add_options()("help, h", "produce help message")("gen, g", po::value<unsigned>(&gen)->default_value(10000u),
        ...
        "verbosity, v", po::value<unsigned>(&verbosity)->default_value(500u),
        "the screen frequency")("pop_size, p", po::value<unsigned>(&pop_size)->default_value(4u), "population size");
    ...
    dcgp::mes4cgp uda(gen, max_mut, 1e-8);
