               ...
               unsigned int N) // number of samples
{
    ...
    bool all_finite;
    // assuming that mutating the program will sooner or later produce an expression that is not nan or inf in any of
    // the points ...
...
audi::gdual_d test_qe2(unsigned int n, unsigned int m, unsigned int r, unsigned int c, unsigned int l, unsigned int a,
                       unsigned int N) // number of samples
{
