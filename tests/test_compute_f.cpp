...
bool f_fails(const dcgp::program& p, const std::vector<double>& in, const std::vector<double>& out)
{
    std::vector<double> out_computed = p.compute_f(in);
...
int main() {
    ...
    dcgp::program one_row(4,1,1,10,10,dcgp::function_set::minimal);
