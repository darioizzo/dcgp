...
foreach(_DCGP_BOOST_COMPONENT ${_DCGP_REQUIRED_BOOST_LIBS})
    if(NOT TARGET Boost::${_DCGP_BOOST_COMPONENT})
        message(STATUS "The 'Boost::${_DCGP_BOOST_COMPONENT}' imported target is missing, creating it.")
        string(TOUPPER ${_DCGP_BOOST_COMPONENT} _DCGP_BOOST_UPPER_COMPONENT)
        if(Boost_USE_STATIC_LIBS)
            add_library(Boost::${_DCGP_BOOST_COMPONENT} STATIC IMPORTED)
        else()
            add_library(Boost::${_DCGP_BOOST_COMPONENT} UNKNOWN IMPORTED)
        endif()
        set_target_properties(Boost::${_DCGP_BOOST_COMPONENT} PROPERTIES
            INTERFACE_INCLUDE_DIRECTORIES "${Boost_INCLUDE_DIRS}")
        set_target_properties(Boost::${_DCGP_BOOST_COMPONENT} PROPERTIES
            IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
            IMPORTED_LOCATION "${Boost_${_DCGP_BOOST_UPPER_COMPONENT}_LIBRARY}")
    endif()
endforeach()
